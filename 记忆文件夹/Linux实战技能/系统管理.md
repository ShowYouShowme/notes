...
+ 脚本路径
  ...
  2. systemctl
     ...
     ```ini
     [Unit]
     Description=hall daemon
     After=network.target
     
     [Service]
     Type=simple
     WorkingDirectory=/home/roglic/hall_ts
     User=roglic
     Group=roglic
     ExecStart=/home/roglic/local/node-v16.17.0-linux-x64/bin/node /home/roglic/hall_ts/bin/index.js
     Restart=always
     RestartSec=2
